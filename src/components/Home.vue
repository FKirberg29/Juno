<template>
  ...
  <div class="divider">
    <img src="../assets/organic.gif" alt="Image 1" class="divider-image">
    <div class="divider-text">USA Certified</div>
  </div>
  <div class="divider">
    <img src="../assets/canada.png" alt="Image 2" class="divider-image">
    <div class="divider-text">Canada Certified</div>
  </div>
  <div class="divider">
    <img src="../assets/mexico.png" alt="Image 3" class="divider-image">
